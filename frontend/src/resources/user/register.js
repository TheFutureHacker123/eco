...
function Register() {
    ...
    let role_id = "User"; // Can be dynamic or based on logic
        ...
        >
            <div className="card" style={{
                ...
                <div className="card-body">
                    <h2 className="card-title text-center" style={{ color: 'white', fontWeight: 'bold' }}>SIGN UP</h2>
                    ...
                    <form>
                        ...
                        <div className="text-center mt-3">
                            <p style={{ color: 'white' }}>Already have an account? <Link to="/login" style={{ textDecoration: 'none' }}>
                                Login
                            </Link></p>
                        </div>
                    </form>
