    ...
    return (
        ...
        >
            <div className="card" style={{
                ...
                <div className="card-body"><div className="text-center mt-3"></div>
                    <h2 className="card-title text-center" style={{ color: 'white', fontWeight: 'bold' }}>RESET PASSWORD</h2>
                    ...
                    <form>
                        ...
                        <div className="text-center mt-3">
                             {/* <p style={{ color: 'white' }}>Don't have an account? <Link to="/signup" style={{ textDecoration: 'none' }}>
                               Sign Up
                            </Link></p> */}
                        </div>
                    </form>
